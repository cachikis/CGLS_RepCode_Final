%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Filename: entry_new.m
% Author: Craig A. Chikis
% Date: 01/11/2021
% Note(s): 
% MA-MFA
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function m = entry_new(s_max)
	...
	rho = power(1+0.0493,1/12/delta)-1;
	xbar = 1;
	...
	tax_rate = 0*ones(1, 2*s_max+1);  
	subsidyE = subsidy(1:(s_max+1));
	B = 0.131986851;%	
	B_entrant = 0.164230057;%	
	PE = false;
	entry_type = "Undirected";
	model_str = "Benchmark";
	phi_wt = 0.111559191;
	phi_wt_exog = 1;
	phi_wt_tilde =0.111559191;
	l = 0;
	l_tilde = 0;
	l_opt = 0;
	l_exog = 0;
